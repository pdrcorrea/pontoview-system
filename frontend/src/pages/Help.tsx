...
const guides: HelpGuide[] = [
  {
    ...
    steps: [
      ...
      "Na primeira conexão, o Player sincroniza a programação e baixa os arquivos necessários antes de iniciar a exibição.",
  ...
  },
  {
    ...
    steps: [
      ...
      "No Google Drive, selecione o arquivo sem enviar uma cópia permanente para a nuvem da PontoView.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Quando uma TV usar essa playlist, o aplicativo baixa uma cópia local gerenciada para o próprio dispositivo. O original continua no seu Drive.",
  ...
  {
    title: "Como a sincronização das TVs funciona",
    summary: "A TV só troca de programação depois que os arquivos da nova versão já estão prontos no dispositivo.",
    intro: "O PontoView separa sincronização e reprodução para evitar telas de carregamento durante a programação.",
    steps: [
      "O Google Drive continua sendo a origem dos seus arquivos; a PontoView guarda na nuvem apenas referências e configurações.",
      "Cada Player mantém uma biblioteca local privada com os arquivos usados pela sua programação.",
      "Ao alterar uma playlist, a versão que já está no ar continua sendo exibida enquanto a nova é sincronizada em segundo plano.",
      "A nova versão só é ativada depois que todos os arquivos do Drive necessários estiverem disponíveis localmente.",
      "Arquivos que não são mais usados podem ser removidos automaticamente da biblioteca local para liberar espaço.",
    ],
    icon: Monitor,
  },
  {
  ...
  },
  {
    ...
    summary: "Vídeos e imagens sincronizados continuam sendo exibidos mesmo quando a conexão cai.",
    intro: "A programação local é independente da internet depois que o snapshot da playlist está pronto.",
    steps: [
      "Vídeos e imagens do Drive da playlist ativa são reproduzidos a partir do armazenamento local do Player.",
      "Clima preserva a última atualização disponível; notícias e mensagens já sincronizadas continuam no snapshot ativo.",
      "YouTube, páginas web e outros conteúdos realmente online podem ser pulados temporariamente quando não houver conexão.",
      "Se uma atualização de playlist estiver incompleta, o Player mantém a versão anterior em exibição em vez de mostrar carregamento.",
      "Quando a internet retorna, a sincronização recomeça automaticamente sem novo pareamento.",
    ],
    icon: Eye,
  },
];
