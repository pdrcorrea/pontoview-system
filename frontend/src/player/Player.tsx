...
function cacheBustedUrl(rawUrl: string, revision: number) { try { const url = new URL(rawUrl, window.location.origin); if (revision > 0) url.searchParams.set("pv_reload", String(revision)); return url.toString(); } catch { return rawUrl; } }
